        ...
        <div className="h-[88%] lg:w-2/3 mx-auto text-white overflow-hidden overflow-y-scroll shadow-lg rounded-2xl p-6 glassy-card custom-scrollbar">
          ...
          <div className="pb-5">
            ...
            <p className="py-3">
              ...
              layout, color scheme, and styling, are inspired by the aesthetic
              of the game. Although the icons and the character have been
              created by me, the design is a direct homage to the game's user
              interface.
            </p>
          </div>
          <div className="pb-5">
            <h3 className="text-2xl pb-3">Background Image</h3>
            <img src={BackgroundImg} alt="" className="w-[70%] mx-auto" />
            ...
            <p className="py-3">
              ...
              rights to the image belong to HoYoverse. It was used for aesthetic
              and inspirational purposes.
            </p>
          </div>
          <div className="pb-5">
            <h3 className="text-2xl pb-3">Button Background</h3>
            <img src={ButtonImg} alt="" className="w-[30%] mx-auto" />
            <p className="text-xs text-center pt-1">
              Source:{" "}
              <a
            ...
            <p className="py-3">
              ...
              <span className="font-bold">Honkai Impact 3rd wiki</span>. These
              images reflect the button design style from the game and are used
              to maintain visual consistency with the original theme.
            </p>
          </div>
          <div className="pb-5">
            ...
            <p className="py-3">
              ...
              <span className="font-bold">personal, non-commercial</span> use
              only. No copyrighted materials have been used inappropriately, and
              credit has been given where due. The site is intended solely as a
              personal portfolio and not for resale or commercial purposes.
            </p>
          </div>
        </div>
      </div>
